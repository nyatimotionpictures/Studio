      ...
      <div className="flex flex-col  gap-6">
        <div className="flex flex-row  gap-8 items-center max-w-[80%]">
          ...
          <div className="">
            ...
            } } className="w-max min-w-[150px]">Upload File</Button>
          </div>
        </div>
...
{/** SD */}
        ...
        film?.type !== "series" && (
          ...
          <div className="flex items-center gap-8 max-w-[80%]">
            <div className="flex flex-col gap-[7px] min-w-[150px]">
              ...
              <p className="font-[Inter-Regular] text-base text-[#706E72]">
                Please upload a file that contains a digital video in SD (480p)
                format for optimal playback and compatibility.
              </p>
            </div>
        ...
        film?.type !== "series" && (
          ...
          <div className="flex items-center gap-8 max-w-[80%]">
            <div className="flex flex-col gap-[7px] min-w-[150px]">
              ...
              <p className="font-[Inter-Regular] text-base text-[#706E72]">
                Please upload a file that contains a digital video in HD (720p)
                format for optimal playback and compatibility.
              </p>
            </div>
        ...
        film?.type !== "series" && (
          ...
          <div className="flex items-center gap-8 max-w-[80%]">
            <div className="flex flex-col gap-[7px] min-w-[150px]">
              ...
              <p className="font-[Inter-Regular] text-base text-[#706E72]">
                Please upload a file that contains a digital video in Full HD
                (1080p) format for optimal playback and compatibility.
              </p>
            </div>
            <div className="">
              <Button onClick={()=> {
        ...
        film?.type !== "series" && (
          ...
          <div className="flex items-center gap-8 max-w-[80%]">
            <div className="flex flex-col gap-[7px] min-w-[150px]">
              ...
              <p className="font-[Inter-Regular] text-base text-[#706E72]">
                Please upload a file that contains a digital video in Ultra HD
                (2160p) format for optimal playback and compatibility.
              </p>
            </div>
            <div className="">
              <Button onClick={()=> {
      ...
      {/** video modal */}
      {openVideoModal && (
       <VideoUpload videoType={videoType}  handleModalClose={handleVideoModalClose} />
      )}
    </div>
  );
};
