          ...
          <CustomStack className="h-full w-full flex flex-col gap-5 text-whites-40">
            ...
            {editdata ? (
              ...
              <FormContainer>
                ...
                >
                  ...
                  <option value="film (feature)">Film (feature)</option>
            ...
            <CustomStack className="flex-row justify-between gap-6">
              ...
              <FormContainer>
                ...
                <ErrorMessage
                  errors={
                    touched?.audioLanguages && errors?.audioLanguages
                      ? true
                      : false
                  }
                  name="audioLanguages"
              ...
              <FormContainer>
                ...
                <ErrorMessage
                  errors={
                    touched?.embeddedSubtitles && errors?.embeddedSubtitles
                      ? true
                      : false
                  }
                  name="embeddedSubtitles"
                  message={
                    errors?.embeddedSubtitles && errors.embeddedSubtitles
                  }
                />
              </FormContainer>
              {/* subtitleLanguage */}
            ...
            <FormContainer>
              ...
              <ErrorMessage
                errors={
                  touched?.yearOfProduction && errors?.yearOfProduction
                    ? true
                    : false
                }
                name="yearOfProduction"
            ...
            <FormContainer>
              ...
              <ErrorMessage
                errors={
                  touched?.releaseDate && errors?.releaseDate ? true : false
                }
                name="yearOfProduction"
            ...
            <FormContainer>
              ...
              <Autocomplete
                ...
                id="genre"
                freeSolo
                options={genreOptions.map((option) => option.label)}
                onChange={(event, newValue) => {
            ...
            <FormContainer>
              ...
              <textarea
                ...
                id="plotSummary"
                name="plotSummary"
                value={values.plotSummary}
                onChange={handleChange}
                placeholder="plot summary - 80-160 words"
              />

              <ErrorMessage
                errors={
                  touched?.plotSummary && errors?.plotSummary ? true : false
                }
                name="plotSummary"
