      ...
      try {
        ...
        if (data.success) {
          ...
          if (isTrailerRequest && data.trailerUrls) {
            ...
            if (trailerHlsUrl) {
              console.log('🎬 Setting trailer HLS URL:', trailerHlsUrl);
              setStreamingUrls({
                hls: {
        ...
        try {
          ...
          if (Hls.isSupported()) {
            ...
            const hls = new Hls({
              ...
              // Optimized loader for better range request handling
              loader: class OptimizedLoader extends Hls.DefaultConfig.loader {
